...
<body>
    <div class="custom-container">
        <div class="form-container">
            ...
            <form id="searchForm">
                ...
                <button type="submit" class="btn btni w-100">확인</button>
    ...
    <script type="text/javascript">
        ...
        function handleFormSubmit() {
            ...
            $.ajax({
                type: "post",
                url: "<%=request.getContextPath()%>/users/search_pw_two.jsp",
                data: { "id": id, "name": name, "email": email },
                dataType: "xml",
                success: function (xmlDoc) {
                    var code = $(xmlDoc).find("code").text();
                    if (code === "success") {
                        var pw = $(xmlDoc).find("pw").text();
                        $("#result").html(name + "님의 임시 비밀번호는 [" + pw + "]입니다.");
                    } else {
                        $("#result").html(name + "님의 비밀번호를 찾을 수 없습니다.");
                        $("#id").addClass("is-invalid");
                        $("#name").addClass("is-invalid");
                        $("#email").addClass("is-invalid");
                    }
