...
<head>
    ...
    <link rel="stylesheet" href="css/q&awrite.css">
...
<body>
    ...
    <script>
        function submitQA(event) {
            ...
            const id = qas.length ? qas[qas.length - 1].id + 1 : 1;
            qas.push({ id, title, content, userid, date, answer, productid });
